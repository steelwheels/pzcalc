...
typedef enum {
	...
	PZMovRightKey			= PZEditKeyMask		| 0x0003,
	PZRetKey			= PZEditKeyMask		| 0x0004,
	PZDelKey			= PZEditKeyMask		| 0x0005,
	
	PZAddKey			= PZOperationKeyMask	| 0x0001,
	PZSubKey			= PZOperationKeyMask	| 0x0002,
	PZMulKey			= PZOperationKeyMask	| 0x0003,
	PZDivKey			= PZOperationKeyMask	| 0x0004,
	PZModKey			= PZOperationKeyMask	| 0x0005,
	PZLessKey			= PZOperationKeyMask	| 0x0006,
	PZGreaterKey			= PZOperationKeyMask	| 0x0007,
	PZEqualKey			= PZOperationKeyMask	| 0x0008,
	PZNotKey			= PZOperationKeyMask	| 0x0009,
	PZLeftParKey			= PZOperationKeyMask	| 0x000A,
	PZRightParKey			= PZOperationKeyMask	| 0x000B,
